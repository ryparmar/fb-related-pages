...
"""
A simple script for scraping posts from a Facebook page.

Credits to: https://github.com/kevinzg/facebook-scraper/tree/c3ccc1e4241ed6fd3c09ad1c7aa22c7f536418a2
"""


def save(file: str, data: dict):
    """Save crawled data into the file"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=10,
        type=int,
        help="how many pages of posts to request, usually the first page has 2 posts and the rest 4. Default is 10.",
    )
    ...
    N = 5  # number of processed pages to save the data (checkpoint)
